...
/******/ 	__webpack_require__.p = "/cloudit/consoleplayer";
/******/
/******/
...
// EXTERNAL MODULE: ./src/GuacaPlayer/index.less
var GuacaPlayer = __webpack_require__(3);

// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/usePrevious.ts
/**
 * 通用hook
 * 用于返回更新前的对象prevProps
*/
...
function usePrevious(value) {
    const ref = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useRef"])();
...
// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useMutaionObserver.ts
/**
 * 通用hook
 * 用于返回更新前的对象prevProps
*/
...
function useMutaionObserver(el, callback = () => { }) {
    const observer = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useMemo"])(() => {
...
// CONCATENATED MODULE: ./src/GuacaPlayer/display.tsx
/**
 * 播放对象渲染容器
*/
...
const Display = ({ display, isPlaying, onClick, playerState, progress, translation }) => {
    const displayRef = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useRef"])(null);
    const el = displayRef.current;
    const fitDisplay = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])(() => {
        // 调整界面大小
        if (!display || !el)
            return;
    ...
    const mutationCallback = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((mutations, observer) => {
    ...
    return (external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.Fragment, null,
        !isPlaying
            &&
                playerState === "ready"
            &&
            ...
            &&
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-pausing", onClick: onClick },
                    external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("i", { className: "iconfont icon-pause" }),
                    external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", null, translation["message.player.pause"])),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-display", ref: displayRef, onClick: onClick })));
};
/* harmony default export */ var GuacaPlayer_display = (Display);

// CONCATENATED MODULE: ./src/GuacaPlayer/utils/index.ts
/**
 * 工具函数
*/
...
function cancelablePromise(promise) {
    let cancelled = false;
    const defered = { promise: null, resolve: null, reject: null };
...
// CONCATENATED MODULE: ./src/GuacaPlayer/control.tsx
/**
 * 播放进度、按钮
*/
...
const Control = ({ currentDuration, duration, playbackPosition, isPlaying, pause, play, onChange }) => {
    const [mouseDown, setMouseDown] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(false);
    const [inputValue, setInputValue] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(playbackPosition);
    const preMouseDown = usePrevious(mouseDown);
    //防抖
    const deb = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useMemo"])(() => {
        return debounce(0);
    }, []);
    const handleBtnClick = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((e) => {
        e.stopPropagation();
        if (isPlaying) {
            pause && pause();
        }
    ...
    const handleMouseEvent = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((boolean, e) => {
        e.stopPropagation();
        setMouseDown(boolean);
    }, []);
    const handleInputChange = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((e) => {
        e.stopPropagation();
        setInputValue(Number(e.target.value));
    }, []);
    Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useEffect"])(() => {
        //如果播放位置没有发生变动则不触发事件
        if (inputValue === playbackPosition && preMouseDown === mouseDown)
            return;
    ...
    return (external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-control" },
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-control-range-wrapper" },
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("input", { className: "guaca-player-range-input", type: "range", min: 0, max: currentDuration || 0, value: playbackPosition || 0, style: { width: `${(currentDuration || 1) / (duration || 1) * 100}%` }, onChange: handleInputChange, onMouseDown: handleMouseEvent.bind(undefined, true), onMouseUp: handleMouseEvent.bind(undefined, false) })),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-control-btn-wrapper" },
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("button", { className: "guaca-player-control-btn", onClick: handleBtnClick },
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("i", { className: `iconfont ${isPlaying ? "icon-pause" : "icon-play"}` })),
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("span", null,
                formatTime(playbackPosition || 0),
                "/",
                formatTime(duration || 0)))));
};
/* harmony default export */ var control = (Control);

// CONCATENATED MODULE: ./src/GuacaPlayer/progress.tsx
/**
 * 加载进度条
 * 类型有文件加载于播放查找进度
 * 文件加载无取消按钮
...
const Progress = ({ translation, progress: { type, current, total, visiable }, onCancel }) => {
    const deg = Math.ceil(current / total * 360) || 0;
    return (external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-progress ${visiable && 'guaca-player-progress-visiable'}` },
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-progress-wrapper` },
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-progress-indicator guaca-player-progress-indicator-back" }),
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-progress-indicator-wrapper ${deg > 180 ? "guaca-clip-auto" : ""}` },
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-progress-indicator guaca-player-progress-indicator-left", style: { transform: `rotate(${deg}deg)` } }),
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-progress-indicator guaca-player-progress-indicator-right ${deg > 180 ? "guaca-clip-right" : ""}` })),
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-progress-text" },
                Math.ceil((current / total * 100) || 0),
                "%")),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("span", null, translation["btn.loading"]),
        type === "seek"
            &&
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("button", { onClick: onCancel }, translation["btn.cancel"])));
};
/* harmony default export */ var GuacaPlayer_progress = (Progress);

// EXTERNAL MODULE: ./node_modules/guacamole-common-js/dist/guacamole-common.js
var guacamole_common = __webpack_require__(1);
var guacamole_common_default = /*#__PURE__*/__webpack_require__.n(guacamole_common);

// CONCATENATED MODULE: ./src/GuacaPlayer/utils/get.ts
let get_headers;
...
function get(url, rangeStart = 0, rangeEnd, trunkSize = 5242880) {
    return new Promise((resolve, reject) => {
        ...
        for (let i in get_headers) {
            xhr.setRequestHeader(i, get_headers[i]);
        }
...
// CONCATENATED MODULE: ./src/GuacaPlayer/utils/mgrDB.ts
...
// CONCATENATED MODULE: ./src/GuacaPlayer/utils/fileCache.ts
/**
 * 文件缓存管理类
 * 缓存20个文件分片
 * 其余通过数据库存取
...
let taskId = 0;
class fileCache_Base {
    constructor() {
        this.url = "";
        this.taskMap = new Map();
        this.filePool = [];
        this.transaction = async (start, end, id) => {
            //查询file事务
            if (fileCache_Base.sessionDB.available) {
                // indexedDB可用
                const result = await fileCache_Base.sessionDB.read({ url: this.url, start, end });
                if (!this.taskMap.has(id))
                    throw Error("db read cancelled");
                if (result) {
                    return result;
                }
            }
            const response = await get(this.url, start, end, fileCache_Base.MAX_FILE_SIZE);
            if (!this.taskMap.has(id))
                throw Error("file http get cancelled");
            try {
                await fileCache_Base.sessionDB.add({ url: this.url, start, end, data: response });
                if (!this.taskMap.has(id))
                    throw Error("db add cancelled");
            }
            catch (e) {
                console.log(e);
            }
        ...
        this.fetching = (start = 0, end = start + fileCache_Base.MAX_FILE_SIZE) => {
            const id = taskId++;
            const promise = cancelablePromise(this.transaction(start, end, id));
            promise.id = id;
            return promise;
        };
...
fileCache_Base.MAX_FILE_SIZE = 5242880;
fileCache_Base.sessionDB = new ManageDatabase();
class Partial {
...
class FileCache extends fileCache_Base {
    constructor() {
        super();
        this.head = null; //头
        this.tail = null; //尾
        ...
        this.init = async (src) => {
            ...
            if (src) {
                ...
                for (let count = this.partialCount = Math.ceil(this.size / fileCache_Base.MAX_FILE_SIZE), i = count - 1; i >= 0; i--) {
                    let start = i * fileCache_Base.MAX_FILE_SIZE, size = end - start;
        ...
        this.slice = async (start, end) => {
            ...
            let startTrunkIndex = Math.ceil((start || 1) / fileCache_Base.MAX_FILE_SIZE) - 1; //start所在的trunk index
            let endTrunkIndex = Math.ceil(end / fileCache_Base.MAX_FILE_SIZE) - 1; //end 所在的trunk index
            let trunkStart = start - startTrunkIndex * fileCache_Base.MAX_FILE_SIZE; //start所在trunk的起始位置
            let trunkEnd = end - endTrunkIndex * fileCache_Base.MAX_FILE_SIZE; //end所在trunk的结束位置
            let blob = new Blob([]);
...
// CONCATENATED MODULE: ./src/GuacaPlayer/sessionRecording.ts
/**
 * 播放帧管理类
 * 解析Blob为帧集合
 * 播放控制
...
class sessionRecording_SessionRecording {
    constructor(fileCache) {
        this.playing = false;
        this.frames = [];
        this.lastKeyframe = 0;
        this.playbackTunnel = new PlaybackTunnel();
        this.playbackClient = new guacamole_common_default.a.Client(this.playbackTunnel);
        this.currentFrame = -1;
        ...
        this.loadFile = async (partial) => {
            ...
            let parser = new guacamole_common_default.a.Parser();
            while (partial) {
                //trunk正在下载中
...
// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useRecording.ts
/**
 * 播放对象初始化调用
*/
...
function useRecording(src) {
    const [recordingState, setRecordingState] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])("uninit");
    //注册service worker
    const serviceWorkerState = false;
    const [recording, setRecording] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(null);
    Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useEffect"])(() => {
        //service worker已经初始化完成才开始启动文件加载
        if (src && serviceWorkerState !== null) {
            let fileCacheInit, fileCache;
            //开始初始化
            setRecordingState("initing");
            //开始获取文件
            fileCache = new FileCache();
            fileCacheInit = cancelablePromise(fileCache.init(src));
            fileCacheInit.then((head) => {
                //初始化完成
                setRecordingState("inited");
                if (head) {
                    const recording = new sessionRecording_SessionRecording(fileCache);
...
// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useProgress.ts
/**
 * 加载进度控制
*/

function useProgress(value = { type: "load", current: 0, total: 0, visiable: false }) {
    const [type, setType] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(value.type);
    const [current, setCurrent] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(value.current);
    const [total, setTotal] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(value.total);
    const [visiable, setVisiable] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(value.visiable);
    const progress = {
        type,
        current,
        total,
...
// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useControl.ts
/**
 * 播放器播放行为控制
*/
...
function useControl(recording, autoPlay, recordingState) {
    // 播放器状态
    const [playerState, setPlayerState] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(recordingState);
    // 播放进度位置
    const [playbackPosition, setPlaybackPosition] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(0);
    // 视频总时长
    const [duration, setDuration] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(0);
    // 当前已加载的视频时长
    const [currentDuration, setCurrentDuration] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(0);
    // 搜索进度位置
    const [seekPosition, setSeekPosition] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(null);
    // 播放状态
    const [isPlaying, setPlaying] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(false);
    // 加载进度条状态
    ...
    const seek = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])(async (e) => {
        // 开始查找防抖
    ...
    const cancelSeek = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])(() => {
        recording && recording.cancel();
        setPlaybackPosition(seekPosition || playbackPosition);
    }, [recording, seekPosition, playbackPosition]);
    Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useEffect"])(() => {
        let getCurrentDuration, getDuration;
        if (recording) {
            //重置状态
            ...
            recording.onTrunkLoad = (event) => {
                ...
                if (event.type === "loaded") {
                    if (event.index === 0) {
                        // 设置视频总时长
                        var getDuration = cancelablePromise(recording.getDuration());
                    ...
                    // 设置视频当前已加载的时长
                    var getCurrentDuration = cancelablePromise(recording.getCurrentDuration());
...
// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useMessage.ts
/**
 * 加载进度控制
*/

function useMessage({ initState, translation }) {
    const [visibility, setVisibility] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(false);
    const [text, setText] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])("");
    const [loading, setLoading] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(false);
    Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useEffect"])(() => {
...
// CONCATENATED MODULE: ./src/GuacaPlayer/message.tsx
/**
 * 加载进度条
 * 类型有文件加载于播放查找进度
 * 文件加载无取消按钮
...
const Message = ({ loading = false, text = "", visibility = false }) => {
    return (external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-message`, style: { display: visibility ? "flex" : "none" } },
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: `guaca-player-message-wrapper` },
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player-message-icon" },
                external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("i", { className: `iconfont ${loading ? "icon-loading guaca-spin" : "icon-warning"}` })),
            external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", null, text))));
};
/* harmony default export */ var message = (Message);

// CONCATENATED MODULE: ./src/GuacaPlayer/hooks/useTranslation.ts
/**
 * 加载进度控制
*/

function useTranlation(callback) {
    const defaultTranslation = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useMemo"])(() => ({
        "btn.loading": "LOADING...",
        "btn.cancel": "CANCEL",
    ...
    const [translation, setTranslation] = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useState"])(defaultTranslation);
    Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useEffect"])(() => {
        if (callback) {
...
// CONCATENATED MODULE: ./src/GuacaPlayer/index.tsx
/**
 * 播放器入口
*/
...
const GuacaPlayer_GuacaPlayer = ({ src, headers, getPlayer, height, width, translate, autoPlay = true }) => {
    //翻译
    ...
    const { progress, playbackPosition, duration, currentDuration, isPlaying, seek, cancelSeek, playerState } = useControl(recording, autoPlay, recordingState);
    //message
    const { loading, visibility, text } = useMessage({ initState: recordingState, translation });
    const player = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useMemo"])(() => {
        if (!recording) {
            return null;
        }
        return {
    ...
    const togglePlayback = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((e) => {
        e.stopPropagation();
        if (recording) {
            if (recording.isPlaying())
                recording.pause();
    ...
    const onPlayRangeChange = Object(external_commonjs_react_commonjs2_react_amd_React_root_React_["useCallback"])((e) => {
        seek(e);
    }, [seek]);
    ...
    return (external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement("div", { className: "guaca-player", style: { height, width } },
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(message, { loading: loading, visibility: visibility, text: text }),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(GuacaPlayer_progress, { progress: progress, onCancel: cancelSeek, translation: translation }),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(GuacaPlayer_display, { display: display, onClick: togglePlayback, isPlaying: isPlaying, playerState: playerState, progress: progress, translation: translation }),
        external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(control, { currentDuration: currentDuration, duration: duration, playbackPosition: playbackPosition, isPlaying: isPlaying, pause: pause, play: play, onChange: onPlayRangeChange })));
};
/* harmony default export */ var src_GuacaPlayer = __webpack_exports__["default"] = (GuacaPlayer_GuacaPlayer);
