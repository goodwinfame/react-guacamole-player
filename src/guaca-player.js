(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["GuacaPlayer"] = factory(require("react"));
	else
		root["GuacaPlayer"] = factory(root["React"]);
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/GuacaPlayer/index.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js!./src/GuacaPlayer/index.less":
/*!***********************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--7-1!./node_modules/postcss-loader/src??ref--7-2!./node_modules/less-loader/dist/cjs.js!./src/GuacaPlayer/index.less ***!
  \***********************************************************************************************************************************************************/
...
/* harmony import */ var _utils_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/index */ "./src/GuacaPlayer/utils/index.ts");
/**
 * 播放进度、按钮
*/


const Control = ({ currentDuration, duration, playbackPosition, isPlaying, pause, play, onChange }) => {
    const [mouseDown, setMouseDown] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
    const [inputValue, setInputValue] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(playbackPosition);
    //防抖
    const deb = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
        return Object(_utils_index__WEBPACK_IMPORTED_MODULE_1__["debounce"])(0);
    }, []);
    const handleBtnClick = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
        e.stopPropagation();
        if (isPlaying) {
            pause && pause();
        }
    ...
    const handleMouseEvent = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((boolean, e) => {
        e.stopPropagation();
        setMouseDown(boolean);
    }, []);
    const handleInputChange = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
        e.stopPropagation();
        setInputValue(Number(e.target.value));
    }, []);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        //如果播放位置没有发生变动则不触发事件
        if (inputValue === playbackPosition)
            return;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-control" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-control-range-wrapper" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", { type: "range", min: 0, max: currentDuration || 0, value: playbackPosition || 0, style: { width: `${(currentDuration || 1) / (duration || 1) * 100}%` }, onChange: handleInputChange, onMouseDown: handleMouseEvent.bind(undefined, true), onMouseUp: handleMouseEvent.bind(undefined, false) })),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-control-btn-wrapper" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { className: "guaca-player-control-btn", onClick: handleBtnClick },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", { className: `iconfont ${isPlaying ? "icon-pause" : "icon-play"}` })),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null,
                Object(_utils_index__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(playbackPosition || 0),
                "/",
                Object(_utils_index__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(duration || 0)))));
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_usePrevious__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/usePrevious */ "./src/GuacaPlayer/hooks/usePrevious.ts");
/* harmony import */ var _hooks_useMutaionObserver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hooks/useMutaionObserver */ "./src/GuacaPlayer/hooks/useMutaionObserver.ts");
/**
 * 播放对象渲染容器
*/
...
const Display = ({ display, onClick }) => {
    const displayRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
    const el = displayRef.current;
    const fitDisplay = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => {
        // 调整界面大小
        if (!display || !el)
            return;
        ...
        if (!displayWidth || !displayHeight)
            return;
        // 根据容器大小缩放视频
        display.scale(Math.min(target.offsetWidth / displayWidth, target.offsetHeight - 40 / displayHeight));
    }, [display, el]);
    const mutationCallback = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((mutations, observer) => {
        fitDisplay();
    }, [display, el]);
    Object(_hooks_useMutaionObserver__WEBPACK_IMPORTED_MODULE_2__["default"])(el, mutationCallback);
    //上一个display对象
    const prevDisplay = Object(_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_1__["default"])(display);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        if (!el) {
            return;
        }
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-display", ref: displayRef, onClick: onClick }));
};
...
/***/ "./src/GuacaPlayer/fonts/iconfont.eot?t=1576230326605":
/*!************************************************************!*\
  !*** ./src/GuacaPlayer/fonts/iconfont.eot?t=1576230326605 ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "data:application/vnd.ms-fontobject;base64,"

/***/ }),

/***/ "./src/GuacaPlayer/fonts/iconfont.svg?t=1576230326605":
/*!************************************************************!*\
  !*** ./src/GuacaPlayer/fonts/iconfont.svg?t=1576230326605 ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),

/***/ "./src/GuacaPlayer/fonts/iconfont.ttf?t=1576230326605":
/*!************************************************************!*\
  !*** ./src/GuacaPlayer/fonts/iconfont.ttf?t=1576230326605 ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "data:font/ttf;base64,"

/***/ }),

/***/ "./src/GuacaPlayer/fonts/iconfont.woff?t=1576230326605":
/*!*************************************************************!*\
  !*** ./src/GuacaPlayer/fonts/iconfont.woff?t=1576230326605 ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "data:font/woff;base64,"

/***/ }),

/***/ "./src/GuacaPlayer/hooks/useControl.ts":
/*!*********************************************!*\
  !*** ./src/GuacaPlayer/hooks/useControl.ts ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return useControl; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _useProgress__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./useProgress */ "./src/GuacaPlayer/hooks/useProgress.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./src/GuacaPlayer/utils/index.ts");
/**
 * 播放器播放行为控制
*/
...
let currentPlayingState = null;
function useControl(recording) {
    // 播放进度位置
    const [playbackPosition, setPlaybackPosition] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0);
    // 视频总时长
    const [duration, setDuration] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0);
    // 当前已加载的视频时长
    const [currentDuration, setCurrentDuration] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0);
    // 搜索进度位置
    const [seekPosition, setSeekPosition] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null);
    // 播放状态
    const [isPlaying, setPlaying] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
    // 加载进度条状态
    const [progress, setProgress] = Object(_useProgress__WEBPACK_IMPORTED_MODULE_1__["default"])();
    //防抖
    const deb = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
        return Object(_utils__WEBPACK_IMPORTED_MODULE_2__["debounce"])(300);
    }, []);
    const seek = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
    ...
    const cancelSeek = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => {
...
/***/ "./src/GuacaPlayer/hooks/useMutaionObserver.ts":
/*!*****************************************************!*\
  !*** ./src/GuacaPlayer/hooks/useMutaionObserver.ts ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return useMutaionObserver; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
 * 通用hook
...
function useMutaionObserver(el, callback = () => { }) {
    const observer = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
...
/***/ "./src/GuacaPlayer/hooks/usePrevious.ts":
/*!**********************************************!*\
  !*** ./src/GuacaPlayer/hooks/usePrevious.ts ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/GuacaPlayer/hooks/useProgress.ts":
/*!**********************************************!*\
  !*** ./src/GuacaPlayer/hooks/useProgress.ts ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return useProgress; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
 * 加载进度控制
...
function useProgress(value = { type: "load", current: 0, total: 0, visiable: false }) {
    const [type, setType] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(value.type);
    const [current, setCurrent] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(value.current);
    const [total, setTotal] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(value.total);
    const [visiable, setVisiable] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(value.visiable);
    const progress = {
        type,
        current,
        total,
    ...
    function setProgress({ type, current, total, visiable }) {
        if (type !== undefined) {
            setType(type);
        }
...
/***/ "./src/GuacaPlayer/hooks/useRecording.ts":
/*!***********************************************!*\
  !*** ./src/GuacaPlayer/hooks/useRecording.ts ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return useRecording; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _sessionRecording__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../sessionRecording */ "./src/GuacaPlayer/sessionRecording.ts");
/* harmony import */ var _utils_fileCache__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/fileCache */ "./src/GuacaPlayer/utils/fileCache.ts");
/**
 * 播放对象初始化调用
*/
...
function useRecording(src) {
    //注册service worker
    const serviceWorkerState = false;
    //初始化资源缓存器
    const fileCache = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
        return new _utils_fileCache__WEBPACK_IMPORTED_MODULE_2__["default"]();
    }, []);
    const [recording, setRecording] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        ...
        if (src && serviceWorkerState !== null) {
            ...
            fileCache.init(src)
                .then(head => {
                if (head) {
                    const recording = new _sessionRecording__WEBPACK_IMPORTED_MODULE_1__["default"](fileCache);
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--7-1!../../node_modules/postcss-loader/src??ref--7-2!../../node_modules/less-loader/dist/cjs.js!./index.less */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js!./src/GuacaPlayer/index.less");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.less */ "./src/GuacaPlayer/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display */ "./src/GuacaPlayer/display.tsx");
/* harmony import */ var _control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./control */ "./src/GuacaPlayer/control.tsx");
/* harmony import */ var _progress__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./progress */ "./src/GuacaPlayer/progress.tsx");
/* harmony import */ var _hooks_useRecording__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hooks/useRecording */ "./src/GuacaPlayer/hooks/useRecording.ts");
/* harmony import */ var _hooks_useControl__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./hooks/useControl */ "./src/GuacaPlayer/hooks/useControl.ts");
/* harmony import */ var _utils_get__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/get */ "./src/GuacaPlayer/utils/get.ts");
/**
 * 播放器入口
*/
...
const GuacaPlayer = ({ src, headers, getPlayer, height, width }) => {
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        headers && Object(_utils_get__WEBPACK_IMPORTED_MODULE_7__["setHeader"])(headers);
    }, [headers]);
    const { recording } = Object(_hooks_useRecording__WEBPACK_IMPORTED_MODULE_5__["default"])(src);
    const { progress, playbackPosition, duration, currentDuration, isPlaying, seek, cancelSeek, } = Object(_hooks_useControl__WEBPACK_IMPORTED_MODULE_6__["default"])(recording);
    const player = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
        if (!recording) {
            return null;
        }
        return {
    ...
    const togglePlayback = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
        e.stopPropagation();
        if (recording) {
            if (recording.isPlaying())
                recording.pause();
    ...
    const onPlayRangeChange = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
        seek(e);
    }, [seek]);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player", style: { height, width } },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_progress__WEBPACK_IMPORTED_MODULE_4__["default"], { progress: progress, onCancel: cancelSeek }),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_display__WEBPACK_IMPORTED_MODULE_2__["default"], { display: display, onClick: togglePlayback }),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_control__WEBPACK_IMPORTED_MODULE_3__["default"], { currentDuration: currentDuration, duration: duration, playbackPosition: playbackPosition, isPlaying: isPlaying, pause: pause, play: play, onChange: onPlayRangeChange })));
};
/* harmony default export */ __webpack_exports__["default"] = (GuacaPlayer);


/***/ }),

/***/ "./src/GuacaPlayer/progress.tsx":
/*!**************************************!*\
  !*** ./src/GuacaPlayer/progress.tsx ***!
  \**************************************/
/*! exports provided: default */
...
const Progress = ({ progress: { type, current, total, visiable }, onCancel }) => {
    const deg = Math.ceil(current / total * 360) || 0;
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: `guaca-player-progress ${visiable && 'guaca-player-progress-visiable'}` },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: `guaca-player-progress-wrapper` },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-progress-indicator guaca-player-progress-indicator-back" }),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: `guaca-player-progress-indicator-wrapper ${deg > 180 ? "guaca-clip-auto" : ""}` },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-progress-indicator guaca-player-progress-indicator-left", style: { transform: `rotate(${deg}deg)` } }),
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: `guaca-player-progress-indicator guaca-player-progress-indicator-right ${deg > 180 ? "guaca-clip-right" : ""}` })),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "guaca-player-progress-text" },
                Math.ceil((current / total * 100) || 0),
                "%")),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "LOADING..."),
        type === "seek"
            &&
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: onCancel }, "CANCEL")));
};
...
/***/ "./src/GuacaPlayer/sessionRecording.ts":
/*!*********************************************!*\
  !*** ./src/GuacaPlayer/sessionRecording.ts ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SessionRecording; });
/* harmony import */ var guacamole_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! guacamole-common-js */ "./node_modules/guacamole-common-js/dist/guacamole-common.js");
/* harmony import */ var guacamole_common_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(guacamole_common_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_fileCache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/fileCache */ "./src/GuacaPlayer/utils/fileCache.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./src/GuacaPlayer/utils/index.ts");
/**
 * 播放帧管理类
 * 解析Blob为帧集合
...
class PlaybackTunnel {
    constructor() {
        this.receiveInstruction = (opcode, args) => {
...
class SessionRecording {
    constructor(fileCache) {
        ...
        this.playbackClient = new guacamole_common_js__WEBPACK_IMPORTED_MODULE_0___default.a.Client(this.playbackTunnel);
        this.currentFrame = -1;
        this.endVideoTimestamp = 0; //视频的结束时间戳
        this.activeSeek = null;
        this.aborted = false; //文件解析取消
        this.seekCallback = null;
        this.frameStart = 0;
        this.frameEnd = 0;
        this.getLastTimestamp = async () => {
            //获取视频最后一帧时间戳
        ...
        this.loadFile = async (partial) => {
            //文件加载中回调
            await Object(_utils__WEBPACK_IMPORTED_MODULE_2__["delay"])();
            ...
            let parser = new guacamole_common_js__WEBPACK_IMPORTED_MODULE_0___default.a.Parser();
            while (partial) {
                //trunk正在下载中
        ...
        this.addFile = async (partial, parser) => {
            const file = await partial.getFile();
            try {
                return this.parseBlob(file, parser, (opcode, args) => {
                    // 计算命令长度
                    ...
                    if (opcode === 'sync') {
                        ...
                        this.onTrunkLoad && this.onTrunkLoad({
                            ...
                            index: partial.index,
                            size: partial.size,
                            current: this.frameEnd - partial.index * _utils_fileCache__WEBPACK_IMPORTED_MODULE_1__["default"].MAX_FILE_SIZE
                        });
                    }
                });
            }
        ...
        this.chartIntervalBetweenFrames = (backFrame, frontFrame) => {
            //计算两帧之间相差多少个字节。
            return backFrame.end - frontFrame.start;
        };
        this.parseBlob = async (blob, parser, instructionCallback) => {
            if (this.aborted) {
                throw "aborted";
            }
        ...
        this.findFrame = (minIndex, maxIndex, timestamp) => {
            //二分法查找
            // 左右index相等则返回结果
            if (minIndex === maxIndex)
                return minIndex;
        ...
        this.seekToFrame = async (index, realTimestamp = 0) => {
            // 终止查询
            this.abortSeek();
            // 设置新的查询标志
            ...
            await Object(_utils__WEBPACK_IMPORTED_MODULE_2__["delay"])(duration);
            // 从当前帧开始播放到目标帧
            do {
                // 播放进度回调
        ...
        this.continuePlayback = async () => {
            ...
            //如果已加载帧长度无变化，则继续等待
            while (this.frames.length <= loadedFrameLength) {
                await Object(_utils__WEBPACK_IMPORTED_MODULE_2__["delay"])(500);
            }
            //继续播放
            this.play();
        };
        ...
        this.seek = async (position, callback) => {
            // position为查询帧的时间戳
            // 没有可播放帧则返回
            if (this.frames.length === 0)
                return;
...
/***/ "./src/GuacaPlayer/utils/fileCache.ts":
/*!********************************************!*\
  !*** ./src/GuacaPlayer/utils/fileCache.ts ***!
  \********************************************/
/*! exports provided: Partial, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./get */ "./src/GuacaPlayer/utils/get.ts");
/* harmony import */ var _mgrDB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mgrDB */ "./src/GuacaPlayer/utils/mgrDB.ts");
/**
 * 文件缓存管理类
 * 缓存20个文件分片
 * 其余通过数据库存取
...
class Base {
    constructor() {
        ...
        this.filePool = [];
        this.fetching = async (start = 0, end = start + Base.MAX_FILE_SIZE) => {
            ...
            const response = await Object(_get__WEBPACK_IMPORTED_MODULE_0__["default"])(this.url, start, end, Base.MAX_FILE_SIZE);
...
Base.MAX_FILE_SIZE = 5242880;
Base.sessionDB = new _mgrDB__WEBPACK_IMPORTED_MODULE_1__["default"]();
class Partial {
    constructor(rangeStart, rangeEnd, size, index, cacher) {
        this.index = 0;
        this.size = 0;
        this.rangeStart = 0;
        this.rangeEnd = 0;
    ...
    constructor() {
        ...
        this.init = async (src) => {
            ...
            if (src) {
                ...
                //构造Partial
                let childNode = null, end = this.size;
        ...
        this.cancelCaching = async () => {
            for (let [id, task] of this.taskMap.entries()) {
                // task.cancel();
            }
        };
        this.slice = async (start, end) => {
            if (!this.head) {
...
function get(url, rangeStart = 0, rangeEnd, trunkSize = 5242880) {
    return new Promise((resolve, reject) => {
...
/***/ "./src/GuacaPlayer/utils/index.ts":
/*!****************************************!*\
  !*** ./src/GuacaPlayer/utils/index.ts ***!
  \****************************************/
/*! exports provided: zeroPad, formatTime, delay, debounce, listener */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/GuacaPlayer/utils/mgrDB.ts":
/*!****************************************!*\
  !*** ./src/GuacaPlayer/utils/mgrDB.ts ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ManageDatabase; });
class ManageDatabase {
    constructor(dbName = "console-player") {
        this.db = null;
        this.version = 1.0;
        this.available = false;
        this.connectionPool = [];
        this.openInitDB = async () => {
